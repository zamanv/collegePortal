"""
Data migration: link faculty profiles to the new department model.
...
def link_faculty_departments(apps, schema_editor):
    FacultyProfile = apps.get_model("faculty", "faculty_profile")
    Department = apps.get_model("faculty", "department")

    for profile in FacultyProfile.objects.all().iterator():
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(link_faculty_departments, noop),
    ]
